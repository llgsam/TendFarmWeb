...
**写作要求（CRITICAL：原生双语，禁止互译）**：
- EN 文章：**用英文思维创作**，把自己想象成一位在 Reddit r/CozyGamers 分享经验的英文玩家。标题、段落结构、比喻、举例——都要符合英语写作习惯，SEO 友好。**不是中文文章的翻译**。
- ZH 文章：**用中文思维创作**，把自己想象成一位在 NGA 或 B站发帖的中文玩家。措辞、游戏名称（用中文惯用名）、推荐理由——都要贴近国内玩家的语境和痛点。**不是英文文章的翻译**。
- 两篇文章可以在切入角度、举例、段落顺序上有差异——这是正常且理想的。
