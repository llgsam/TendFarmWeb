...
**Farm Game Hub 是农场游戏爱好者的集结地**——帮玩家发现游戏、玩得更好、和社区互动。
...
```
Farm Game Hub（网站品牌）= 农场游戏爱好者集结地（双语，zh/en 并重）
...
```
Header:
🌿 Farm Game Hub     游戏大全  工具集  测评  游戏攻略  [TendFarm App]     语言切换
   农场游戏集结地
```
...
- 视觉结果卡片：适合截图，含结果标题 + 简短描述 + Farm Game Hub 水印 + 二维码/链接
...
| 优先级 | 内容 | 说明 |
|--------|------|------|
| P0 | 品牌改名（TendFarm → Farm Game Hub） | Header、Footer、metadata |
