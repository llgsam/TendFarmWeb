        ...
        <div className="mb-4 rounded-xl border border-[#2d3d2d] bg-[#0f1a0f] p-4">
          <p className="text-center text-sm text-[#8a9a7a]">
            {getLoc(
              ...
              'TendFarmはファームリズムトラッカーを開発中です——ゲームの集中リズムをリアルな毎日に。',
              'TendFarm은 농장 리듬 트래커를 개발 중입니다——게임 속 집중 리듬을 실제 일상으로.',
              'TendFarm entwickelt einen Farm-Rhythmus-Tracker — der fokussierte Rhythmus aus Spielen ins echte Leben bringen.',
            )}
          </p>
        </div>
