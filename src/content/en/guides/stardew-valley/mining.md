---
title: "Stardew Valley Mining Guide: Floors, Ores, Combat, and the Skull Cavern"
description: "Complete Stardew Valley mining guide — how to progress through the mine, what to bring, how to fight efficiently, reaching floor 120, and conquering the Skull Cavern for iridium."
game: "stardew-valley"
slug: "mining"
publishedAt: "2026-06-27"
tags: ["mining", "combat", "guide", "skull-cavern"]
faqs:
  - q: "How do I get to the bottom of the mine in Stardew Valley?"
    a: "The mine has 120 floors. Clear all enemies on a floor and find the ladder down (either hidden under a rock or dropped by enemies). Floors 40 and 80 have minecarts that let you warp back to previously visited checkpoint floors. Bring food for healing, good weapons, and bombs for breaking rocks quickly. Reaching floor 120 unlocks the Skull Cavern and rewards you with the Skull Key."
  - q: "What should I bring to the mine in Stardew Valley?"
    a: "Essential items: your best sword or club, your pickaxe (at least copper-upgraded), food for healing (Cheese restores 136 HP and is easy to make), bombs (break rocks faster and reveal ladders), and coffee for speed. Optional but useful: Staircases (craft from stone to skip floors), Jade (transmute to diamonds for money), and rings like the Burglar's Ring (more monster drops)."
  - q: "What is in the Skull Cavern in Stardew Valley?"
    a: "The Skull Cavern is an infinite-floor dungeon in the Calico Desert (accessed after getting the Skull Key from mine floor 120). It contains Iridium Ore (the best crafting material), Prismatic Shards (rarest item in the game), and strong enemies. There's no bottom — go as deep as possible. Reaching floor 100 is a community milestone; serious players use bombs and staircases to reach 200+."
  - q: "What is the best weapon in Stardew Valley?"
    a: "The best endgame weapons are the Galaxy Sword (obtained by bringing a Prismatic Shard to the three pillars in the desert) and its upgrade, the Infinity Blade (crafted at the forge). For mid-game, the Lava Katana (purchased from the Adventurer's Guild after reaching floor 80) is excellent. Clubs are better for AoE room clearing; swords are better for single targets."
  - q: "How do I get to the Skull Cavern quickly?"
    a: "Buy the Desert Warp Totem from Sandy's shop or craft it. Bring a large stack of Staircases (craft from 99 stone each) to skip difficult floors. Use Bombs and Mega Bombs to break rocks in 4-tile bursts rather than one at a time. Eat spicy food for the mining speed boost. The goal is reaching as many floors as possible before 2am when the day ends."
---
...
1. **Gold nodes** (dark brown/metallic) — highest value ore, needed for final tool upgrades
2. **Iron nodes** (gray) — essential mid-game crafting material
3. **Copper nodes** (orange-brown) — important early, less critical once you have iron
4. **Stone** — infinite value for staircases and bomb crafting; mine when convenient
...
**Strategy**:
1. Check TV's fortune forecast — high luck days are best for Skull Cavern runs
2. Drink Lucky Lunch food immediately on entering
3. Use bombs to clear multiple rocks at once — look for a ladder before using staircases
4. If no ladder appears after 5-6 bombs, place a staircase and move on
5. Fight enemies only if they block you — otherwise run past
6. Prioritize Iridium nodes when spotted but don't detour far to reach them
