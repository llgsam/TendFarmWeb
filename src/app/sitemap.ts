...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  for (const p of ['/games', '/tools', '/tools/hay-day', '/tools/stardew', '/tools/stardew-calendar', '/tools/stardew-gifts', '/tools/stardew-fish', '/tools/stardew-bundles', '/tools/stardew-museum', '/tools/stardew-villagers', '/quizzes']) {
    add(p)
  }
