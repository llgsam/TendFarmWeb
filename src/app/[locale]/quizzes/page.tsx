...
const QUIZZES = [
  ...
  {
    slug: 'farming-rpg-adventure-quiz',
    emoji: '⚔️',
    titleZh: '农场RPG冒险游戏推荐测验',
    titleEn: 'Which Farming RPG Adventure Is Right for You?',
    descZh: '6道题帮你从Harvestella、符文工房5、Paleo Pines和牧场物语橄榄镇中找到最适合的农场RPG冒险游戏',
    descEn: '6 questions to match you with your farming RPG — Harvestella, Rune Factory 5, Paleo Pines, or Story of Seasons Pioneers of Olive Town.',
    tagZh: '农场RPG推荐',
    tagEn: 'Farming RPG Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
    isNew: true,
  },
  {
    slug: 'cozy-indie-farm-quiz',
    emoji: '🌿',
    titleZh: '治愈独立农场游戏推荐测验',
    titleEn: 'Which Cozy Indie Farming Game Is Right for You?',
    descZh: '6道题从Dinkum、Kynseed、Littlewood和旅者驿站中找出最适合你的隐藏宝藏农场游戏',
    descEn: 'Dinkum, Kynseed, Littlewood, or Travellers Rest — find your hidden gem cozy farming game in 6 questions.',
    tagZh: '治愈独立农场推荐',
    tagEn: 'Cozy Indie Farm Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
    isNew: true,
  },
  {
    slug: 'spirit-farm-life-quiz',
    emoji: '🌸',
    titleZh: '灵气农场生活风格测验',
    titleEn: 'Which Spirit Farm Life Game Is Right for You?',
    descZh: '6道题从Spirittea、仙武门、Moonglow Bay和Everdream Valley中找出你的灵气农场生活游戏',
    descEn: 'Spirittea, Immortal Life, Moonglow Bay, or Everdream Valley — find your spirit farming life match.',
    tagZh: '灵气农场推荐',
    tagEn: 'Spirit Farm Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
    isNew: true,
  },
