...
const QUIZZES = [
  ...
  {
    slug: 'new-wave-farm-quiz',
    emoji: '🌱',
    titleZh: '新浪潮农场游戏推荐测验',
    titleEn: 'Which New-Wave Farming Game Is Right for You?',
    descZh: '6道题从梅林回响、Sugardew Island、生长常树之歌和Farm Together 2中找出你的新浪潮农场游戏',
    descEn: 'Echoes of the Plum Grove, Sugardew Island, Grow Song of the Evertree, or Farm Together 2 — find your match.',
    tagZh: '新浪潮农场推荐',
    tagEn: 'New-Wave Farm Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
    isNew: true,
  },
