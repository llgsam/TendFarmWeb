...
const QUIZZES = [
  ...
  {
    slug: 'cozy-play-as-animal',
    emoji: '🐾',
    titleZh: '你该玩哪款以动物为主角的 Cozy 游戏？',
    titleEn: 'Which Game Where You Play as an Animal Should You Try?',
    descZh: '6 个问题，从 Stray（赛博朋克流浪猫）、Cattails（猫族领地建设）、Snufkin（姆明谷漫步）、Pupperazzi（狗狗摄影）中找到你的动物主角游戏。',
    descEn: '6 questions to match you with Stray, Cattails: Wildwood Story, Snufkin: Melody of Moominvalley, or Pupperazzi — the perfect animal protagonist game for your style.',
    tagZh: '动物主角',
    tagEn: 'Play as Animal Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
    isNew: true,
  },
  {
    slug: 'stardew-fishing-quiz',
    emoji: '🎣',
    titleZh: '你的星露谷钓鱼风格是哪种？',
    titleEn: 'What Is Your Stardew Valley Fishing Style?',
    descZh: '传奇鱼猎手、被动蟹笼玩家、任务单完成者，还是鱼塘专家？6 个问题揭示你的钓鱼风格，附完整星露谷钓鱼攻略指南。',
    descEn: 'Legendary Hunter, Passive Crabpotter, Bundle Completionist, or Fish Pond Expert? 6 questions to reveal your Stardew fishing playstyle — each result comes with a full strategy guide.',
    tagZh: '钓鱼攻略',
    tagEn: 'Fishing Style Guide',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
    isNew: true,
  },
  {
    slug: 'cozy-weird-games',
    emoji: '🤔',
    titleZh: '哪款最难向朋友解释的 Cozy 游戏最适合你？',
    titleEn: 'Which Impossible-to-Explain Cozy Game Is Perfect for You?',
    descZh: '橡皮鸭漂浮、做一个洞吃掉小镇、当小邮差、清理外星海洋——6 个问题找到你的奇异 Cozy 游戏。',
    descEn: 'Watch rubber ducks float, be a hole eating a town, deliver mail as a tiny creature, or clean alien ocean pollution. 6 questions to find your perfect weird cozy game.',
    tagZh: '奇异推荐',
    tagEn: 'Weird Cozy Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
    isNew: true,
  },
  {
    slug: 'cozy-hidden-gems',
    emoji: '💎',
    titleZh: '哪款被低估的 Cozy 游戏隐藏宝石最适合你？',
    titleEn: 'Which Underrated Cozy Hidden Gem Should You Play?',
    descZh: '6 个问题，从四款被严重低估的 Cozy 精品中找到你的隐藏宝石——熊开民宿、日式夜市手工、暖系像素末日、药水店谈判牌组。',
    descEn: '6 questions to find your hidden gem — Bear and Breakfast, Mineko\'s Night Market, Eastward, or Potionomics. All underplayed, all excellent.',
    tagZh: '隐藏宝石',
    tagEn: 'Hidden Gem Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
    isNew: true,
  },
  {
    slug: 'cozy-rpg-quiz',
    emoji: '🎮',
    titleZh: '哪款独立 RPG 最适合 Cozy 游戏玩家？',
    titleEn: 'Which Indie RPG Is Perfect for a Cozy Gamer?',
    descZh: '6 个问题，从 Moonlighter、Cassette Beasts、时光帽、CrossCode 中找到你的 RPG 进阶游戏——超越农场类型的独立精品。',
    descEn: '6 questions to find your ideal indie RPG — Moonlighter (shopkeeper + dungeons), Cassette Beasts (monster fusion), A Hat in Time (3D platformer), or CrossCode (60hr anime RPG).',
    tagZh: 'RPG 进阶推荐',
    tagEn: 'Indie RPG Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
    isNew: true,
  },
  {
    slug: 'cozy-2023-surprise-hits',
    emoji: '⭐',
    titleZh: '哪款 2023 精品会让 Cozy 玩家意外爱上？',
    titleEn: 'Which 2023 Game Would a Cozy Gamer Unexpectedly Love?',
    descZh: '6 个问题，从星之海、Hi-Fi Rush、塞纳尔圣歌、Jusant 中找到最适合你的 2023 年度惊喜之作——四款 Game Pass 可玩的精品。',
    descEn: '6 questions to match you with Sea of Stars, Hi-Fi Rush, Chants of Sennaar, or Jusant — four acclaimed 2023 games available on Game Pass that cozy gamers unexpectedly love.',
    tagZh: '2023 惊喜推荐',
    tagEn: '2023 Surprise Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
    isNew: true,
  },
  ...
  {
    slug: 'creature-raising-quiz',
    emoji: '🫧',
    titleZh: '哪款生物养成游戏最适合你？',
    titleEn: 'Which Creature-Raising Game Is Right for You?',
    descZh: '6 个问题，从 Slime Rancher 2、怪物避难所、DQ 怪兽仙境 The Dark Prince、Temtem 中找到你的生物养成游戏——从纯 Cozy 牧场到竞技 MMO。',
    descEn: '6 questions to match you with Slime Rancher 2, Monster Sanctuary, Dragon Quest Monsters: The Dark Prince, or Temtem — from pure cozy ranching to competitive online battling.',
    tagZh: '生物养成推荐',
    tagEn: 'Creature Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
  ...
  {
    slug: 'cozy-management-quiz',
    emoji: '🏗️',
    titleZh: '哪款管理模拟游戏最适合 Cozy 玩家？',
    titleEn: 'Which Management Sim Is Right for Cozy Gamers?',
    descZh: '6 个问题，从 Two Point Campus、Planet Zoo、Two Point Hospital、Planet Coaster 2 中找到你的管理经营游戏——校园、动物园、医院还是主题公园？',
    descEn: '6 questions to match you with Two Point Campus, Planet Zoo, Two Point Hospital, or Planet Coaster 2 — university, zoo, hospital, or theme park?',
    tagZh: '管理模拟推荐',
    tagEn: 'Management Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
    isNew: true,
  },
  {
    slug: 'deep-think-games-quiz',
    emoji: '🧩',
    titleZh: '哪款「深度思考」游戏最适合你？',
    titleEn: 'Which Deep-Think Game Is Right for You?',
    descZh: '6 个问题，从空洞骑士、Inscryption、被遗忘的城市、Pentiment 中找到你的下一款挑战性游戏——探索、卡牌、时间循环还是历史叙事？',
    descEn: '6 questions to match you with Hollow Knight, Inscryption, The Forgotten City, or Pentiment — exploration combat, card horror, time loop mystery, or historical narrative?',
    tagZh: '深度思考推荐',
    tagEn: 'Deep Think Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
    isNew: true,
  },
  {
    slug: 'jrpg-finder-quiz',
    emoji: '🗺️',
    titleZh: '哪款 JRPG 最适合你？',
    titleEn: 'Which JRPG Is Right for You?',
    descZh: '6 个问题，从歧路旅人 II、三角战略、异度神剑 3、莱莎的炼金工房中找到你的完美 JRPG——各具独特故事风格、战斗系统和时间投入，总有一款适合你。',
    descEn: '6 questions to find your perfect JRPG — Octopath Traveler II, Triangle Strategy, Xenoblade Chronicles 3, or Atelier Ryza. Each has a distinct story style, combat system, and time commitment.',
    tagZh: 'JRPG 推荐',
    tagEn: 'JRPG Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
  ...
  {
    slug: 'nintendo-switch-exclusives-quiz',
    emoji: '🎮',
    titleZh: '哪款 Nintendo Switch 独占游戏最适合你？',
    titleEn: 'Which Nintendo Switch Exclusive Is Right for You?',
    descZh: '6 个问题，从塞尔达：王国之泪、皮克敏 4、超级马力欧兄弟：奇妙之旅、星之卡比：探索发现中找到你的专属推荐——四款 2022-2023 年度最佳 Switch 独占精品。',
    descEn: '6 questions to match you with Zelda: Tears of the Kingdom, Pikmin 4, Super Mario Bros. Wonder, or Kirby and the Forgotten Land — the four best Nintendo Switch exclusives of 2022-2023.',
    tagZh: 'Switch 独占推荐',
    tagEn: 'Switch Exclusive Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
    isNew: true,
  },
  {
    slug: 'cozy-survival-games-quiz',
    emoji: '🏕️',
    titleZh: '哪款生存游戏最适合 Cozy 玩家？',
    titleEn: 'Which Survival Game Is Right for Cozy Gamers?',
    descZh: '6 个问题，从 Raft 木筏求生、核心守护者、光年边疆、缩小与生存中找到你的生存游戏——从漂浮木筏家园到外星机甲农场到后院求生，温馨程度各不相同。',
    descEn: '6 questions to match you with Raft, Core Keeper, Lightyear Frontier, or Grounded — from a floating raft home to an alien mech farm to backyard survival. All accessible to cozy gamers.',
    tagZh: '生存游戏推荐',
    tagEn: 'Survival Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
  ...
  {
    slug: 'rhythm-games-quiz',
    emoji: '🎵',
    titleZh: '哪款节奏游戏最适合你？',
    titleEn: 'Which Rhythm Game Is Right for You?',
    descZh: '6 个问题，从再见狂心、长号冠军、亡灵舞者、褪黑素中找到你的节奏游戏——合成流行音乐视频、搞笑长号表演、节奏 Roguelike 还是梦境节拍，四款完全不同的体验。',
    descEn: '6 questions to find your perfect rhythm game — Sayonara Wild Hearts (cinematic synth-pop), Trombone Champ (comedic trombone), Crypt of the NecroDancer (rhythm roguelike), or Melatonin (dreamy cozy beats).',
    tagZh: '节奏游戏推荐',
    tagEn: 'Rhythm Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
  ...
  {
    slug: 'detective-narrative-games-quiz',
    emoji: '🕵️',
    titleZh: '哪款侦探叙事游戏最适合你？',
    titleEn: 'Which Detective Narrative Game Is Right for You?',
    descZh: '6 个问题，从极乐迪斯科、黄金神像案、永生、天堂穹顶中找到你的侦探游戏——技能检定 RPG、视觉推理、电影档案谜题还是古语言破译？',
    descEn: "6 questions to match you with Disco Elysium, The Case of the Golden Idol, Immortality, or Heaven's Vault — skill-check RPG, visual deduction, film archive mystery, or ancient language decipherment.",
    tagZh: '侦探叙事推荐',
    tagEn: 'Detective Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
    isNew: true,
  },
  {
    slug: 'photography-games-quiz',
    emoji: '📷',
    titleZh: '摄影游戏推荐测验',
    titleEn: 'Which Photography Game Is Right for You?',
    descZh: '6道题帮你找出最适合的摄影游戏：新宝可梦随手拍、Toem、Alba还是Umurangi Generation？',
    descEn: 'New Pokémon Snap, Toem, Alba: A Wildlife Adventure, or Umurangi Generation — find your perfect photography game in 6 questions.',
    tagZh: '摄影游戏推荐',
    tagEn: 'Photography Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
    isNew: true,
  },
  {
    slug: 'dark-atmospheric-games-quiz',
    emoji: '🌑',
    titleZh: '黑暗大气游戏推荐测验',
    titleEn: 'Which Dark Atmospheric Game Is Right for You?',
    descZh: '6道题精准推荐：小小梦魇2、心跳文学部、Oxenfree II 还是 Signalis？为 cozy 玩家挖掘黑暗系佳作。',
    descEn: 'Little Nightmares II, Doki Doki Literature Club, Oxenfree II, or Signalis — 6 questions to find your perfect dark game.',
    tagZh: '黑暗大气推荐',
    tagEn: 'Dark Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
  ...
  {
    slug: 'deckbuilder-roguelike-quiz',
    emoji: '🃏',
    titleZh: '卡牌构筑Roguelike推荐测验',
    titleEn: 'Which Deckbuilder Roguelike Is Right for You?',
    descZh: 'Cobalt Core、怪物列车、暗黑地牢2还是Across the Obelisk？6道题精准匹配你的卡牌构筑风格。',
    descEn: 'Cobalt Core, Monster Train, Darkest Dungeon II, or Across the Obelisk — 6 questions to find your deckbuilder match.',
    tagZh: '卡牌构筑推荐',
    tagEn: 'Deckbuilder Pick',
    timeZh: '约 2 分钟',
    timeEn: '~2 min',
    isNew: true,
  },
